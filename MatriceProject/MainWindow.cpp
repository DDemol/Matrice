...
void MainWindow::setScene(GraphicsScene *scene)
{
    ...
    draw->setStyleSheet(CSSWidget::getButtonStyleSheet(":/Resources/draw.png"));
    edit->setStyleSheet(CSSWidget::getButtonStyleSheet(":/Resources/edit.png"));
    recognize->setStyleSheet(CSSWidget::getButtonStyleSheet(":/Resources/gesture.png"));
